...
<template>
  ...
  >
    <div class="flex items-center justify-between mb-3">
      ...
      <div class="text-xs opacity-70 uppercase tracking-wide">DNS</div>
    </div>
    ...
    <div class="space-y-2">
      ...
      <div class="text-xs opacity-80 space-y-1">
        ...
        <div v-if="data.config?.recursion">
          Recursion: Enabled
        </div>
      </div>
    </div>

    <Handle type="target" :position="Position.Left" class="!bg-purple-500 !border-purple-600" />
    <Handle type="source" :position="Position.Right" class="!bg-purple-500 !border-purple-600" />
  </div>
</template>